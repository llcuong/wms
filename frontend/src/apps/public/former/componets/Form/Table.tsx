    ...
    return (
        ...
        >
            ...
            {(actionButtons.length > 0 || informationElement || pagination) && (
                <div
                    className="sticky bottom-0 z-20 bg-white border-t border-gray-200 shadow-[0_-4px_12px_rgba(0,0,0,0.03)]">
                    ...
                    `}
                                ...
                                {selectedRows.size > 0 && (
                                    <span
                                        className="text-xs font-bold text-indigo-600 bg-indigo-50 px-2.5 py-1 rounded-full animate-pulse">
                    {selectedRows.size} Selected
                        ...
                        {informationElement && (
                            <div
                                className="text-sm font-medium text-gray-500 bg-gray-50 px-4 py-2 rounded-lg border border-gray-100">
                                {informationElement}
                            </div>
                        )}
                    </div>
